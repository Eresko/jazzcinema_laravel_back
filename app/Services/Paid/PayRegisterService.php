...
{
    public function orderPayRegister(string $orderId, string $amount, int $performanceId)
    {
        ...
        $data = [
            ...
            'orderNumber' => $orderId,
            'amount' => $amount,
            'returnUrl' => $loginPay->getUrl() . 'reservation/' . $performanceId . '/?transaction=' . $orderId
        ];
